...
# Two brackets are considered to be a matched pair if an opening bracket (i.e., (, [, or {) occurs to the left of a closing bracket (i.e., ), ], or }) of the exact same type.
...
def do_brackets_match(brackets):
...
if do_brackets_match('{{[[(())]]}}') == "YES":
    print("PASS")
if do_brackets_match("{[(])}") == "NO":
    print("PASS")
